    ...
    view! {
        <div class="py-8 px-6">
            <div class="flex flex-col space-y-4 mx-auto">
                <h1 class="text-2xl font-bold mb-8 text-center text-gray-100">To cut it short</h1>
                <div class="flex flex-row justify-center space-x-4 items-center">
                    <img
                        src="/images/profile.png"
                        alt="Profile Picture"
                        class="w-32 h-32 rounded-full outline-4 outline-green outline-offset-4"
                    />
                    <p>
                ...
                <p>
                    "I have historically also enjoyed:" <ul class="list-disc list-inside ml-4">
