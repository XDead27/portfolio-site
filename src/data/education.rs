    ...
    view! {
        <section class="py-8 px-6">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-2xl font-bold mb-8 text-center text-gray-100">Education</h1>
                ...
                <div class="flex items-start shadow-md rounded-sm p-6 mb-8 border-l-8 border-green space-x-4 cursor-pointer hover:bg-beige-200/20 transition-colors duration-300">
                    ...
                    <div>
                        <h2 class="text-xl font-semibold text-gray-200">MSc Computer Science</h2>
                ...
                <div class="flex items-start shadow-md rounded-sm p-6 mb-8 border-l-8 border-green space-x-4 cursor-pointer hover:bg-beige-200/20 transition-colors duration-300">
                    ...
                    <div>
                        ...
                        <ul class="list-disc list-inside mt-3 text-gray-400">
                            <li>
                                Paper: <em>Spatio-temporal Learning Rule</em>
                                (published at IEICE 2024)
                            </li>
                ...
                <div class="flex items-start shadow-md rounded-sm p-6 mb-8 border-l-8 border-green space-x-4 cursor-pointer hover:bg-beige-200/20 transition-colors duration-300">
                    ...
                    <div>
                        ...
                        <ul class="list-disc list-inside mt-3 text-gray-400">
                            <li>
                                Thesis: <em>Accelerating t-SNE using the Lorentz Hyperboloid</em>
                            </li>
