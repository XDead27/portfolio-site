...
pub fn HexChessProject() -> impl IntoView {
    view! {
        <div class="flex flex-row h-full">
            <div class="basis-1/3">
                <img src="/images/hexagon.png" alt="Hexagon Chess Showcase" class="h-full w-full object-cover object-top-left"/>
            </div>
            <div class="basis-2/3 flex items-center justify-center h-full py-8 px-6 max-w-4xl mx-auto">
                <div>
                    <h1 class="text-2xl font-bold mb-8 text-center text-gray-100">"Online Hexagon Chess"</h1>
